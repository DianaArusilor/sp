t=0:.2:8;
%se urmareste reprezentarea a 4 perioade cu rezolutie temporara de 20ms
...
%se observa importanta rezolutiei temporare mare, fapt ce conduce la concluzia
%ca aceasta trebuie sa fie cat mai mica, ideal sa tinda la 0